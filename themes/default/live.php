...
<?php
if ($agoraStatus == '1') {?>
<script src="<?php echo filter_var($base_url, FILTER_VALIDATE_URL); ?>themes/<?php echo filter_var($currentTheme, FILTER_SANITIZE_STRING); ?>/js/agora.js?v=<?php echo filter_var($version, FILTER_SANITIZE_STRING);?>"></script>
  ...
  return new Promise((resolve, reject) => {
    ...
    navigator.mediaDevices.getUserMedia(constraints)
      .then(str => {
        ...
        $('#remote-media .liv_vid_cont .filtvid').html('<div style="width: 100%; height: 100vh; position: absolute; background-color: black; overflow: hidden;"><video  id="basic-stream" class="hidden videostream" style="width: 100%; height: 100vh; position: absolute; transform: rotateY(180deg); object-fit: cover;" autoplay="" muted="" playsinline=""></video></div>');
      }).catch(err => {

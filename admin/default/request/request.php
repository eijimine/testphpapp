...
/*Update Payment Settings*/
	if ($type == 'paymentSettings') {
		if (isset($_POST['default_currency']) && isset($_POST['fee_comission']) && isset($_POST['min_sub_weekly']) && isset($_POST['min_sub_monthly']) && isset($_POST['min_sub_yearly']) && isset($_POST['min_point_amount']) && isset($_POST['max_point_amount']) && isset($_POST['point_to_dolar']) && isset($_POST['min_withdrawl_amount'])) {
			...
			if (empty($minFeePointWeekly) || empty($minFeePointMonthly) || empty($minFeePointYearly) ||empty($minimumSubscriptionAmountMonthly) || empty($minimumSubscriptionAmountWeekly) || empty($minimumSubscriptionAmountYearly) || empty($minimumPointAmount) || empty($maximumPointAmount) || empty($pointToMoney) || empty($minWihDrawlAmount)) {
				exit('1');
			}
			$updatePaymentSettings = $iN->iN_UpdatePaymentSettings($userID, $iN->iN_Secure($defaultSubType), $iN->iN_Secure($defaultCurrency), $iN->iN_Secure($comissionFee), $iN->iN_Secure($minimumSubscriptionAmountWeekly), $iN->iN_Secure($minimumSubscriptionAmountMonthly), $iN->iN_Secure($minimumSubscriptionAmountYearly), $iN->iN_Secure($minimumPointAmount), $iN->iN_Secure($maximumPointAmount), $iN->iN_Secure($pointToMoney), $iN->iN_Secure($minWihDrawlAmount), $iN->iN_Secure($minFeePointWeekly), $iN->iN_Secure($minFeePointMonthly),$iN->iN_Secure($minFeePointYearly));
